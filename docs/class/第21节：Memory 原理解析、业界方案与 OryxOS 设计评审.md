...
![短期记忆与长期记忆：工作台与仓库](../../images/class-21-1.svg)
...
![记忆的完整循环：对话累积、压缩提炼、写入归档、检索拼回](../../images/class-21-2.svg)
...
![MemGPT 记忆即操作系统：主上下文相当于内存，外部存储相当于磁盘](../../images/class-21-3.svg)
...
![接口墙设计：MemoryService 接口不变，实现可从关键词升级到向量检索](../../images/class-21-4.svg)
...
![OryxOS 三层记忆结构：会话记忆 + 长期记忆（核心/归档分区）](../../images/class-21-5.svg)
