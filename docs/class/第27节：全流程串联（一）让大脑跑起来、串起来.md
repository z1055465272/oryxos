...
![人推链路八站：输入、AgentService、PromptBuilder、Provider、ToolExecutor、Tool、Session、落库](../../images/class-27-1.svg)
...
![五条典型缝隙：JPA 扫描、工具双调、session_id 口径、Bootstrap 静默、审计断点](../../images/class-27-2.svg)
