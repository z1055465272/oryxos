...
![三种触发源：CLI/Web Service 人推，AgentScheduler 钟推，汇入同一个 AgentService](../../images/class-25-1.svg)
...
![定时任务负责什么、不管什么](../../images/class-25-2.svg)
...
![定时任务执行流程：AgentScheduler 到点触发、拿锁、跑 ReAct 循环、写审计](../../images/class-25-3.svg)
