...
![ReAct 是什么：Reason 想、Act 做、Observe 看的循环](../../images/class-17-1.svg)
...
![动手前想清楚：ReActLoop 的边界（停止条件/上下文/累积）](../../images/class-17-2.svg)
...
![ReAct 循环实现：接消息、组装 Prompt、调 LLM、判断是否有工具调用](../../images/class-17-3.svg)
